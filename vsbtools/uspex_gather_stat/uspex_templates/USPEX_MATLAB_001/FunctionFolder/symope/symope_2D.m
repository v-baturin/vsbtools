function [candidate, lattice, errorS] = symope_2D(nsym, numIons, volume, minD, thickness)
...
Write_Stokes_input_2D(numIons, minD, nsym, volume, thickness, fixRndSeed);
...
function Write_Stokes_input_2D(numIons, minD, nsym, volume, thickness, fixRndSeed)
