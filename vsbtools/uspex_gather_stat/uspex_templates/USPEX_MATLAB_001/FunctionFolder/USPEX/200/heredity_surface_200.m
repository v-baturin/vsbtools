function [numIons, offspring,potentialLattice,fracFrac,dimension,offset] = heredity_surface_200(par_one,par_two,cell)
...
[lat1, parent1, par_order1, par_numIons1]=cresupercell(lat1,coor1,numIons1,...
                                               lat_base, cell, atomType);
[lat2, parent2, par_order2, par_numIons2]=cresupercell(lat2,coor2,numIons2,...
                                               lat_base, cell, atomType);
...
% determine the thickness of the unit cell while cutting in a given 
% direction (not equal to the lattice vector for non-cubic cells!)
if dimension == 1
...
numIons = ORG_STRUC.numIons*det(reshape(cell, [2,2]));
