function [numIons, offspring, potentialLattice, fracFrac, dimension, offset, fracLattice, parents1] = h1eredity_final_clusterMP(parents)
...
[numIons, offspring, potentialLattice, fracFrac, dimension, offset, fracLattice] = h1eredity_cluster(parentcor1,parentcor2,parentlat1,parentlat2,order1,order2,numIons1,numIons2,frac);
frac = rand(1);
for i = 3 : Np
    ...
    [numIons, offspring, potentialLattice, fracFrac, dimension, offset, fracLattice] = h1eredity_cluster(parentcor1,parentcor2,parentlat1,parentlat2,order1,order2,frac);
end
