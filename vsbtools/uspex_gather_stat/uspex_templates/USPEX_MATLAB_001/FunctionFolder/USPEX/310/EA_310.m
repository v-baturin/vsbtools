...
while POP_STRUC.generation < ORG_STRUC.numGenerations + 0.5
    ...
    if ORG_STRUC.currentGenDone == 0
        ...
        if ~((ORG_STRUC.pickedUP == 1) & ...
            ...
            fitness = AntiSeedsCorrection(fitness); %we don't have antiSeeds 
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        Operation = {'Heredity_310', 'Random_310', 'Permutation_310', ...
             'Rotation_310', 'LatMutation_310', 'SoftModeMutation_310'};
        Num_Opera = [ORG_STRUC.fracGene, ORG_STRUC.fracRand,...
              ORG_STRUC.fracPerm, ORG_STRUC.fracRotMut, ...
