function Correlation(fitness)

global POP_STRUC

% correlation between fitness and order:
POP_STRUC.cor_dir = 1;
POP_STRUC.correlation_coefficient = 0;
j = 1;
FvsO = zeros(1,2);
...
POP_STRUC.correlation_coefficient = correlation_coefficient;
POP_STRUC.cor_dir = sign(correlation_coefficient); % > 0 - correlation, < 0 - anticorrelation
