...
global USPEX_STRUC
  ...
  indic  = ORG_STRUC.conv_till;
  gen    = USPEX_STRUC.POPULATION(Ind_No).gen;
symg     = USPEX_STRUC.POPULATION(Ind_No).symg;
enth     = USPEX_STRUC.POPULATION(Ind_No).Enthalpies(indic); % enthalpy of the last relaxtion step
...
KPOINTS  = USPEX_STRUC.POPULATION(Ind_No).K_POINTS(indic,:);
