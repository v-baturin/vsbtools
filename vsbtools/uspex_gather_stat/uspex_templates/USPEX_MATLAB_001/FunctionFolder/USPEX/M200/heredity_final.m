...
dimension = RandInt(1,1,[1,2]);     %choose only x-y directions
...
Nslab1  = heredity_NSlab(lat1, numIons1, corr, dimension);
Nslab2  = heredity_NSlab(lat1, numIons2, corr, dimension);
[parent1, whichIons1] = heredity_Slab(parent1, order1,...
                  Nslab1, frac, dimension, cor_dir, 1);
[parent2, whichIons2] = heredity_Slab(parent2, order2,...
                  Nslab2, frac, dimension, cor_dir, 2);
