...
while notDone
    ...
    if step > 10
        ...
        %  lattice
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        % unixCmd(['echo main_structure >> POSCAR_cluster']);
        % unixCmd(['echo ' '1.0' ' >> POSCAR_cluster']);
        %for latticeLoop = 1:3
        %  unixCmd(['echo ' num2str(lattice(latticeLoop,:)) ' >> POSCAR_cluster']);
        %end
        % unixCmd(['echo ' num2str(numIons) ' >> POSCAR_cluster']);
        % unixCmd(['echo ' 'Direct' ' >> POSCAR_cluster']);
        %for coordLoop = 1:N
        %  unixCmd(['echo ' num2str(coord(coordLoop,:)) ' >> POSCAR_cluster']);
        %end
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        % quit
