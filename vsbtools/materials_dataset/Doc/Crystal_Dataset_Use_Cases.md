...
REPO_ROOT = Path(vsbtools.__file__).parent
RAW_GENERATIONS = REPO_ROOT / 'materials_dataset/Examples/raw_generations'
...
```python
from vsbtools.materials_dataset.energy_estimation.nn_estimator import NNEstimator
from vsbtools.materials_dataset.energy_estimation import grace_bridge
