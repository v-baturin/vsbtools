...
if __name__ == '__main__':
    ...
    from vsbtools.materials_dataset.analysis.structural_distance.rdf_fingerprint import RadialFingerprint, compute_fingerprint
    from vsbtools.materials_dataset.io.structures_dataset_io import  StructureDatasetIO
    from vsbtools.materials_dataset.io.uspex_bridge import USPEXBridge
    from vsbtools.materials_dataset.converters import cell_pos_atomtypes_from_pmg_structure
