...
from ..coordination_tools import compute_average_coordination_atoms, _to_torch_from_atoms, _soft_neighbor_counts_per_A, compute_target_coordination_share_atoms
...
class symmetry_tools_Test(unittest.TestCase):
    ...
    def test_pretty_phasediag(self):
        ...
        self.assertAlmostEqual(compute_target_coordination_share_atoms(self.system, type_A="B", type_B="O", target=3.),
                               0.57, delta=0.05)
