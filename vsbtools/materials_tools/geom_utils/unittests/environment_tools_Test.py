...
from ..coordination_tools import compute_species_pair_atoms, _to_torch_from_atoms, _soft_neighbor_counts_per_A, compute_target_share_atoms
...
class symmetry_tools_Test(unittest.TestCase):
    ...
    def test_pretty_phasediag(self):
        self.assertAlmostEqual(compute_species_pair_atoms(self.system, type_A="B", type_B="O", kernel='sigmoid'),
                               3.43, delta=0.1)
